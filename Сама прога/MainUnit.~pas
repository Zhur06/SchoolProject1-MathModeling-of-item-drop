...
begin
  ...
  else if Edit1.Text = '' then Edit1.Text := 'Введите h'
...
begin
  ...
  else if Edit2.Text = '' then Edit2.Text := 'Введите v'
...
begin
  ...
  else if Edit3.Text = '' then Edit3.Text := 'Введите угол к горизонту'
...
begin
  ...
  else if Edit4.Text = '' then Edit4.Text := 'Введите h'
...
begin
  ...
  else if Edit5.Text = '' then Edit5.Text := 'Введите g'
